...
if (fs_1.default.existsSync(targetFile)) {
    console.error(colors_1.default.red("File \"".concat(outputPath, "\" was created before.")));
}
else {
    fs_extra_1.default.copySync(path_1.default.join(__dirname, '../libs/iconfont.json'), targetFile);
    console.log(colors_1.default.green("File \"".concat(outputPath, "\" is created now. We recommend you add it to version control.")));
}
