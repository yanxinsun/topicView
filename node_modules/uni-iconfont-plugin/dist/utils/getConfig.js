...
var iconfont_json_1 = tslib_1.__importDefault(require("../libs/iconfont.json"));
...
var getConfig = function () {
    ...
    if (!fs_1.default.existsSync(targetFile)) {
        console.warn(colors_1.default.red("File \"".concat(configFilePath, "\" doesn't exist, did you forget to generate it?")));
        process.exit(1);
    }
