...
var fetchXml = function (url) { return tslib_1.__awaiter(void 0, void 0, void 0, function () {
            ...
            case 2:
                ...
                if (matches_1) {
                    return [2 /*return*/, new Promise(function (resolve, reject) {
                            (0, xml2js_1.parseString)("<svg>".concat(matches_1[1], "</svg>"), { rootName: 'svg' }, function (err, result) {
                                if (err) {
                                    reject(err);
                                }
                                else {
